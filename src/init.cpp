...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/cuelgacoin-project/cuelgacoin>";
    const std::string URL_WEBSITE = "<https://cuelgacoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Cuelgacoin version %s\n", FormatFullVersion());
}
