...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s cuelgacoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  cuelgacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cuelgacoin transaction") + "\n" +
              "  cuelgacoin-tx [options] -create [commands]   " + _("Create hex-encoded cuelgacoin transaction") + "\n" +
              "\n";
