...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.cuelgacoin.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.cuelgacointools.com", true);
        vSeeds.emplace_back("dnsseed.cuelgacoinpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.cuelgacointools.com", true);
        vSeeds.emplace_back("seed-b.cuelgacoin.loshan.co.uk", true);
